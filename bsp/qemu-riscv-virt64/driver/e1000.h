...
//
#define     VIRT_PCIE_ECAM_ADDR     (0x30000000L)
#define     PCIE_E1000_ADDR         (0x100e8086)
#define     E1000_REGS_ADDR         (0x40000000L)
#define     E1000_IRQ               (33)
...
#define E1000_TDBAH    (0x03804/4)   /* Transmit Descriptor Base High - R/W */
...
struct rx_desc
{
  rt_uint64_t addr;       /* Address of the descriptor's data buffer */
  rt_uint16_t length;     /* Length of data DMAed into data buffer */
  rt_uint16_t csum;       /* Packet checksum */
  rt_uint8_t status;      /* Descriptor status */
  rt_uint8_t errors;      /* Descriptor Errors */
  rt_uint16_t special;
};
